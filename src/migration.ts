...
const assignRolesToExistingUsers = async () => {
  ...
  const toursRef = collection(db, 'tours'); // Assuming tours might have a userId
...
// To run this script, you would typically call this function from a secure, admin-only
// interface or a command-line script. For example:
